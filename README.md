...
| When | Script | What |
|---|---|---|
| 10:10 Tuesday - Saturday | `crosswords_daily.sh` | NYT Daily/Mini/Midi crosswords (only if `NYT_S_COOKIE` is set)
| 17:10 daily | `wordle_daily.sh` | Wordle |
| 03:10 daily | `spelling_bee_daily.sh` | Spelling Bee |
| 04:00 Sundays | `weekly_xwords_pull.sh` | `git pull`s your archive repo |
