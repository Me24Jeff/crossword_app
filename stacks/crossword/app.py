...
app = Flask(__name__)
app.secret_key = os.environ.get('FLASK_SECRET_KEY', 'crossword-secret-key-change-this-in-production')
    ...
    for y in range(height):
        ...
        for x in range(width):
            ...
            if cell == 0:
                ...
                row.append({
                    "block": False,
                    "solution": cell[0].upper() if cell else "",
...
def index():
    ...
    today_titles['spelling-bee'] = "Make as many words as you can with 7 letters."
